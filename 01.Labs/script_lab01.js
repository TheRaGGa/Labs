...
// const index1 = arr2.indexOf("Rufet"); 
// const index2 = arr2.indexOf("Fuad"); 
    // const result = arr2.slice(index1, index2);
    // console.log(result);
    ...
    // const nameAnar = arr2.filter(name => name === "Anar");
    // console.log(nameAnar);
    
    // // 5.Console all names where name is Anar change it to "Perviz"
    
    // const index1 = arr2.indexOf("Anar");
    // const index2 = arr2.indexOf("Anar");
    // const index3 = arr2.indexOf("Anar");
    // arr2[index1] = "Perviz"
    // arr2[index2] = "Perviz"
    // arr2[index3] = "Perviz"
    
    // const names = arr2.map((name, index) => (name === "Anar" ? "Perviz" : name));
    // console.log(names);
    


// // 6.Console second to last value of arr2
  // const name1 = arr2.filter((item, i) => i > 0)
  // console.log(name1);
